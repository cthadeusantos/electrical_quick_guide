...
\begin{enumerate}
	...
	\item Instruções específicas para salas de freezers:
		\begin{enumerate}
			\item \label{24h:revezamento}Em edificações que não possuem climatização 24h, deverão ser instalados no mínimo 2(dois) pontos de força para ar-condicionado em salas de freezer cujo funcionamento será de 24h em regime de revezamento, 12h / 12h.
